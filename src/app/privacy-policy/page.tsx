...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
      <Head>
        <title>Privacy Policy | SYNC TECH</title>
        <meta name="description" content="Read the SYNC TECH privacy policy to understand how we collect, use, and protect your personal information when you use our website and services." />
        <meta name="keywords" content="privacy policy, data protection, GDPR, user data, information security, SYNC TECH privacy" />
      </Head>
