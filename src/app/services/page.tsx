...
export const metadata: Metadata = {
  ...
  keywords: ["IT services Dublin", "web development Ireland", "AI automation services", "cybersecurity solutions", "managed cloud services", "FinOps consulting", "digital growth SEO", "game development company", "Stripe integration"],
};
