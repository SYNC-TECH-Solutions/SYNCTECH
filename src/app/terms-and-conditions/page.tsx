...
export default function TermsAndConditionsPage() {
  ...
  return (
     <>
      <Head>
        <title>Terms and Conditions | SYNC TECH</title>
        <meta name="description" content="Read the terms and conditions for using the SYNC TECH website and our services. Understand your rights and responsibilities when you engage with us." />
        <meta name="keywords" content="terms and conditions, terms of service, legal terms, website use policy, service agreement, SYNC TECH legal" />
      </Head>
