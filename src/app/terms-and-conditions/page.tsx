            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground">
                           If you have any questions about these Terms and Conditions, please contact us at: <a href="mailto:synctechire@gmail.com" className="text-primary hover:underline">synctechire@gmail.com</a>
                        </p>
                    </div>
                </CardContent>
            </Card>
